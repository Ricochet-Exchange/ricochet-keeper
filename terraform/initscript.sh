...
sed -i'' -e 's/key1/${key1};s/address1/${address1};s/key2/${key2};s/address2/${address2};s/key3/${key3};s/address3/${address3};s/key4/${key4};s/address4/${address4};s/key5/${key5};s/address5/${address5};s/key6/${key6};s/address6/${address6};s/key7/${key7};s/address7/${address7};s/gateway-URI/${gateway_uri};s/gateway-WSS/${gateway_wss};s/airflow_password/${airflow_password};s/postgres_password/${postgres_password};'
.vars
