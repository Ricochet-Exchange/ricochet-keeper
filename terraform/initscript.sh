...
sed -i~ 's/key1/${key1}/g'; 's/address1/${address1}/g'; 's/key2/${key2}/g'; 's/address2/${address2}/g'; 's/key3/${key3}/g'; 's/address3/${address3}/g'; 's/key4/${key4}/g'; 's/address4/${address4}/g'; 's/key5/${key5}/g'; 's/address5/${address5}/g'; 's/key6/${key6}/g'; 's/address6/${address6}/g'; 's/key7/${key7}/g'; 's/address7/${address7}/g'; 's/gateway-URI/${gateway-uri}/g'; 's/gateway-WSS/${gateway-wss}/g'; 's/a-strong-postgres-password/${airflow_password}/g'; 's/a-strong-postgres-password/${postgres_password}/g'; .vars
